...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Category name cannot be empty' }),
    (0, class_validator_1.IsString)({ message: 'Category name must be a string' }),
    (0, class_validator_1.MaxLength)(255, { message: 'Category name must not exceed 255 characters' }),
